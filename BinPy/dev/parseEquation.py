    ...
    if position != -1:
        ...
        for i in equation[position:]:
            if (i == '(') and (stack != -1):
                ...
                stack -= 1
                if stack == 0:
                    # If the current index corresponds to the ) of the removed
                    # gate.
                    stack = -1
                    # print i,stack,eq
                else:
...
def eqnParse(eqn, isOperandtype=str.isalpha):
    # The second parameter is to support the passing of equations for pin
    # class [ only numbers ]
    ...
    while len(operators) > 0:
        ...
        if operator == '~':
            ...
            operands.append(
                'AND(' + operands.pop() + ',' + operands.pop() + ')')
        elif operator == '|':
            operands.append(
                'OR(' + operands.pop() + ',' + operands.pop() + ')')
        elif operator == '^':
            operands.append(
                'XOR(' + operands.pop() + ',' + operands.pop() + ')')
    ...
    while unoptimized:
        ...
        if pos != -1:
            unoptimized = True
            equation_final = equation_final[:pos] + \
                equation_final[pos:].replace('NOT(AND(', 'NAND(', 1)
        ...
        if pos != -1:
            unoptimized = True
            equation_final = equation_final[:pos] + \
                equation_final[pos:].replace('NOT(OR(', 'NOR(', 1)
            equation_final = removeBraces(pos, equation_final)
            # print equation_final
        ...
        if pos != -1:
            unoptimized = True
            equation_final = equation_final[:pos] + \
                equation_final[pos:].replace('NOT(XOR(', 'XNOR(', 1)
            equation_final = removeBraces(pos, equation_final)
            # print equation_final
        ...
        if pos != -1:
            unoptimized = True
            equation_final = equation_final[:pos] + \
                equation_final[pos:].replace('AND(AND(', 'AND(', 1)
            equation_final = removeBraces(pos, equation_final)
            # print equation_final
        ...
        if pos != -1:
            unoptimized = True
            equation_final = equation_final[:pos] + \
                equation_final[pos:].replace('OR(OR(', 'OR(', 1)
            equation_final = removeBraces(pos, equation_final)
            # print equation_final
        ...
        if pos != -1:
            unoptimized = True
            equation_final = equation_final[:pos] + \
                equation_final[pos:].replace('XOR(XOR(', 'XOR(', 1)
            equation_final = removeBraces(pos, equation_final)
            # print equation_final
        ...
        if pos != -1:
            unoptimized = True
            equation_final = equation_final[:pos] + \
                equation_final[pos:].replace('NAND(NAND(', 'NAND(', 1)
            equation_final = removeBraces(pos, equation_final)
            # print equation_final
        ...
        if pos != -1:
            unoptimized = True
            equation_final = equation_final[:pos] + \
                equation_final[pos:].replace('NOR(NOR(', 'NOR(', 1)
            equation_final = removeBraces(pos, equation_final)
            # print equation_final
        ...
        if pos != -1:
            unoptimized = True
            equation_final = equation_final[:pos] + \
                equation_final[pos:].replace('XNOR(XNOR(', 'XNOR(', 1)
            equation_final = removeBraces(pos, equation_final)
            # print equation_final
        ...
        if pos != -1:
            unoptimized = True
            equation_final = equation_final[:pos] + \
                equation_final[pos:].replace('NAND(AND(', 'NAND(', 1)
            equation_final = removeBraces(pos, equation_final)
            # print equation_final
        ...
        if pos != -1:
            unoptimized = True
            equation_final = equation_final[:pos] + \
                equation_final[pos:].replace('NOR(OR(', 'NOR(', 1)
            equation_final = removeBraces(pos, equation_final)
            # print equation_final

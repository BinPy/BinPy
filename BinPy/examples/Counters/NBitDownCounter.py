...
print("\n")
print("Initializing Down Counter with 4 bits and clock_conn")
print("b = NBitDownCounter(4, clk_conn)")
b = NBitDownCounter(4, clk_conn)

# Initiating the oscilloscope
print("\n")
print("Initializing the Oscillioscope")
print("o = Oscilloscope((clk_conn, 'CLK'), (b.out[0], 'BIT3'), (b.out[1], 'BIT2'), (\

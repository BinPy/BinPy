...
def test_IC_7418():
    testIC = IC_7418()
    p = {1: 1, 2: 0, 3: 0, 4: 0, 5: 0, 9: 1,
         10: 1, 11: 1, 12: 1, 13: 1, 14: 1, 7: 0}
    testIC.setIC(p)
    q = {6: 1, 8: 0}
    if q != testIC.run():
        assert False
...
def test_IC_7451():
    testIC = IC_7451()
    p = {2: 1, 3: 0, 4: 0, 5: 0, 7: 0, 1: 1,
         13: 1, 12: 1, 11: 0, 10: 0, 9: 0, 14: 1}
    testIC.setIC(p)
    q = {6: 1, 8: 0}
    if q != testIC.run():
        assert False
...
def test_IC_74260():
    testIC = IC_74260()
    p = {1: 0, 2: 0, 3: 0, 4: 1, 7: 0, 8: 0, 9:
         0, 10: 0, 11: 0, 12: 0, 13: 0, 14: 1}
    testIC.setIC(p)
    q = {5: 1, 6: 0}
    if q != testIC.run():
        assert False
...
def test_IC_74133():
    testIC = IC_74133()
    p = {1: 0, 2: 1, 3: 1, 4: 1, 5: 1, 6: 1, 7: 1, 8: 0,

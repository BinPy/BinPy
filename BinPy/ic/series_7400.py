...
#IC_7412 IC_7413 to be added

class IC_7420:
	'''
	This is a double 4 input NAND gate IC
	'''
	def __init__(self):
		self.pins = [None,0,0,None,0,0,None,0,None,0,0,None,0,0,None]
		self.gates = Gates()
...
class IC_7421:
	'''
	This is a double 4 input AND gate IC
	'''
	def __init__(self):
		self.pins = [None,0,0,None,0,0,None,0,None,0,0,None,0,0,None]
		self.gates = Gates()

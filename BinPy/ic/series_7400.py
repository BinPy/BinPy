...
class IC_7400(Base_14pin):
    ...
    def __init__(self):
        self.pins = [None, 0, 0, None, 0, 0,
                     None, 0, None, 0, 0, None, 0, 0, 0]
...
class IC_7404(Base_14pin):
    ...
    def __init__(self):
        self.pins = [None, 0, None, 0, None, 0,
...
class IC_7413(Base_14pin):
    ...
    def run(self):
        output = {}
        output[6] = NAND(self.pins[1], self.pins[
                         2], self.pins[4], self.pins[5]).output()
        output[8] = NAND(self.pins[9], self.pins[
                         10], self.pins[12], self.pins[13]).output()
        if self.pins[7] == 0 and self.pins[14] == 1:
            return output
        else:
            print "Ground and VCC pins have not been configured correctly."
...
class IC_7421(Base_14pin):
    ...
    def run(self):
        output = {}
        output[6] = AND(self.pins[1], self.pins[
                        2], self.pins[4], self.pins[5]).output()
        output[8] = AND(self.pins[9], self.pins[
                        10], self.pins[12], self.pins[13]).output()
        if self.pins[7] == 0 and self.pins[14] == 1:
            return output
        else:
...
class IC_7425(Base_14pin):
    ...
    def run(self):
        output = {}
        output[6] = NOR(self.pins[1], self.pins[
                        2], self.pins[3], self.pins[4], self.pins[5]).output()
        output[8] = NOR(self.pins[9], self.pins[10], self.pins[
                        11], self.pins[12], self.pins[13]).output()
        if self.pins[7] == 0 and self.pins[14] == 1:
            return output
        else:
            print "Ground and VCC pins have not been configured correctly."
...
class IC_7430(Base_14pin):
    ...
    def run(self):
        output = {}
        output[8] = NAND(self.pins[1], self.pins[2], self.pins[3], self.pins[
                         4], self.pins[5], self.pins[6], self.pins[11], self.pins[12]).output()
        if self.pins[7] == 0 and self.pins[14] == 1:
            return output
        else:
            print "Ground and VCC pins have not been configured correctly."
...
class IC_7451(Base_14pin):
    ...
    def run(self):
        ...
        output[8] = NOR(
            AND(self.pins[1], self.pins[13], self.pins[12]).output(),
...
class IC_7454(Base_14pin):
    ...
    def run(self):
        ...
        temp.append(
            OR(AND(self.pins[9], self.pins[10], self.pins[11]).output(),
...
class IC_7464(Base_14pin):
    ...
    def run(self):
        ...
        output[8] = NOR(AND(self.pins[2], self.pins[3]).output(),
                        ...
                        AND(self.pins[1], self.pins[11], self.pins[
                            13], self.pins[12]).output(),
...
class IC_7431(Base_16pin):
    ...
    def __init__(self):
        self.pins = [None, 0, None, 0, None, 0, 0,
                     None, 0, None, 0, 0, None, 0, None, 0, 0]
...
class IC_7442(Base_16pin):
    ...
    def __init__(self):
        self.pins = [None, None, None, None, None, None,
                     None, None, 0, None, None, None, 0, 0, 0, 0, 0]
    ...
    def run(self):
        ...
        output[1] = NAND(
            NOT(self.pins[15]).output(), NOT(self.pins[14]).output(),
...
class IC_74133(Base_16pin):
    ...
    def run(self):
        ...
        output[9] = NAND(
            self.pins[1], self.pins[2], self.pins[3], self.pins[4],
            self.pins[5], self.pins[6], self.pins[7], self.pins[10],
            self.pins[11], self.pins[
                12], self.pins[13], self.pins[14],
            self.pins[15]).output()
...
class IC_7483(Base_16pin):
    ...
    def __init__(self):
        self.pins = [None, 0, None, 0, 0, 0, None,
                     0, 0, None, 0, 0, 0, 0, None, None, 0]
